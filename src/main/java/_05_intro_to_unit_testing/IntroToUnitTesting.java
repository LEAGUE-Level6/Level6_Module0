...
small programs, when you begin working on applications with greater complexity, manually testing every piece of functionality
 whenever a change is made becomes a much more time-consuming task.
...
A unit test is responsible for verifying that one small piece (i.e. "unit") of code works correctly.
...
Please review that code there for an understanding how it works, then move on to the next section.
 */
